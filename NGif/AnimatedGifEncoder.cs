...
namespace NGif
{
	public class AnimatedGifEncoder
	{
		...
		protected void AnalyzePixels() 
		{
			...
			//LRC NeuQuant nq = new NeuQuant(pixels, len, sample);
			// initialize quantizer
			//LRC colorTab = nq.Process(); // create reduced palette
...
//			}
			...
			for (int i = 0; i < nPix; i++) 
			{
                ...
                indexedPixels[i] = (byte)index; //(byte) index;
			}
			//pixels = null;
			colorDepth = 8;
			palSize = 7;
